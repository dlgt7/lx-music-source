...
// 服务端地址
const API_URL = "http://musicapi.haitangw.net"
// 服务端配置的请求key
const API_KEY = ``
// 音质配置(key为音源名称,不要乱填.如果你账号为VIP可以填写到hires)
// 全部的支持值: ['128k', '320k', 'flac', 'flac24bit']
const MUSIC_QUALITY = JSON.parse('{"kw":["128k","320k","flac","flac24bit"],"kg":["128k","320k","flac","flac24bit"],"tx":["128k","320k","flac","flac24bit","dolby","master"],"wy":["128k","320k","flac","flac24bit"],"mg":["128k","320k","flac","flac24bit","jyeffect"]}')
...
// MD5值,用来检查更新
const SCRIPT_MD5 = '438ceb8ce77417d449873e3e81cc660f'
